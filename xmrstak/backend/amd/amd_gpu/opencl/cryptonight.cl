...
// crypto_night_heavy || crypto_night_haven || crypto_night_bittube2 || crypto_night_superfast
...
// crypto_night_monero || crypto_night_aeon || crypto_night_ipbc || crypto_night_stellite || crypto_night_masari || crypto_night_bittube2
...
// crypto_night_ipbc || crypto_night_bittube2
#	if(ALGO == 6 || ALGO == 10)
...
// crypto_night_heavy || crypto_night_bittube2
#if (ALGO == 4 || ALGO == 10)
...
//  crypto_night_haven || crypto_night_superfast
#elif (ALGO == 9 || ALGO == 12)
			long n = *((__global long*)(Scratchpad + (IDX((idx0) >> 4))));
			int d = ((__global int*)(Scratchpad + (IDX((idx0) >> 4))))[2];
			long q = fast_div_heavy(n, d | 0x5);
